 ...
 */
@MultipartConfig
@WebServlet(name = "Main Servlet", urlPatterns = {"/MainServlet"})
public class MainServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        BundleDirectoryManager bundleDirMgmt = (BundleDirectoryManager) getServletContext().getAttribute("bundleDirMgmt");
